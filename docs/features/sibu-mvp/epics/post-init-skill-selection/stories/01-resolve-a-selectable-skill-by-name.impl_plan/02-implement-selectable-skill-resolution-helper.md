...
- Return an unknown-skill failure for non-matches with a short message that suggests `sibu skills list`.
...
- Unknown ids such as `nope` produce a failure result whose message suggests `sibu skills list`.
