...
- Keep the result shape simple and reusable by the future `sibu skills use` command handler.
...
- Unknown skill resolution can carry a concise message that suggests `sibu skills list`.
