...
## Summary
Make required skills, selectable skills, and human-identified missing skill opportunities visible enough for the team to use Sibu while assigning concrete follow-up work.
...
- Document human-identified missing required and selectable skills in `docs/features/sibu-mvp/missing_skills.md`.
