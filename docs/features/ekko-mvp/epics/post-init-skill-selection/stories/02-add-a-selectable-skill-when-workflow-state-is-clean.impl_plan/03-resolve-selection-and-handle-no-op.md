...
- For unknown skills, exit without changes and show the helper message suggesting `ekko skills list`.
...
- Do not create skill files, refresh `AGENTS.md`, or update `.ekko/state.json` in this step.
...
- `ekko skills use typescript` can distinguish unavailable, already-selected, and newly selectable cases after a clean-state check.
