...
Model Windsurf as a supported Ekko agent target in the shared TypeScript types and catalog without introducing any Windsurf-specific workflow file or template.
