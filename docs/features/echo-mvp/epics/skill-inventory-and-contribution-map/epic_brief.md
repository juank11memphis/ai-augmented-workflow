...
## Summary
Make required skills, selectable skills, and human-identified missing skill opportunities visible enough for the team to use Echo while assigning concrete follow-up work.
...
- Document human-identified missing required and selectable skills in `docs/features/echo-mvp/missing_skills.md`.
