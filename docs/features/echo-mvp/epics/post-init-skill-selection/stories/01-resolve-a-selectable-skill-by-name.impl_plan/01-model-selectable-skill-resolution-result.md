...
- Keep the result shape simple and reusable by the future `echo skills use` command handler.
...
- Unknown skill resolution can carry a concise message that suggests `echo skills list`.
