...
- Show advisory messaging that tells the user to run `npm install -g @juancr11/sibu` when a newer version exists.
...
- The advisory explicitly points to `npm install -g @juancr11/sibu`.
