...
### Fixed
- align skill dependency routing
...
### Added
- add managed session-start hook targets
- add exporter subagent templates
- support supplemental skill targets

### Changed
- sync managed session hook files
- assert session hook command behavior
- cover session hook managed lifecycle
- update exporter agent templates
- sync workflow skill templates

### Removed
- remove manual session doctor preflight

### Fixed
- run exporter subagents without blocking
...
### Added
- enforce mandatory skill interviews

### Changed
- add npm re-login release guidance
...
### Changed
- require deployable scrum stories
...
### Changed
- strengthen deep module map interviews

## 0.12.3 - 2026-05-12

### Changed
- add project documentation module
- refine readme contributor guidance
- add readme workflow and skills inventory
- improve readme landing quickstart

## 0.12.2 - 2026-05-12

### Fixed
- resolve open questions in design templates

## 0.12.1 - 2026-05-12

### Changed
- add clean-code input validation guidance

## 0.12.0 - 2026-05-12

### Added
- require approval for github issue mcp writes

## 0.11.1 - 2026-05-12

### Changed
- strengthen React component guidance
